...
$$
\alpha = \min\left(1,\; \frac{p(x' \mid \mathbf{Y}_p)\, q(x \mid x')}{p(x \mid \mathbf{Y}_p)\, q(x' \mid x)}\right) = \min\left(1,\; \frac{p(x' \mid \mathbf{Y}_p)}{p(x \mid \mathbf{Y}_p)}\right).
$$
